    ...
    <div style={{ width: "100%" }}>
      ...
      <div style={{ marginTop: 16, background: "white", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 16, padding: 16 }}>
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
          ...
          />
          <div style={{ padding: "10px 12px", borderRadius: 12, border: "1px solid rgba(0,0,0,0.10)", background: "rgba(0,0,0,0.03)" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 700 }}>
              ...
              <tbody>
                {filteredRows.map((r, idx) => (
                  <tr key={idx}>
                    {columns.map((c) => (
                      <td key={c} style={{ padding: 10, borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
                        {String((r as any)?.[c] ?? "")}
                      </td>
                    ))}
                  </tr>
